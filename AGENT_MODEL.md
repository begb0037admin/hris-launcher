...
| 1.1     | 2026-06-18 | Section 8 updated: added            |
|         |            | command-centre, ag-flexpoints,      |
|         |            | hris-launcher, hris-change-requests;|
|         |            | removed desktop-tutorial.           |
|         |            | Seat C updated to Claude Code.      |
